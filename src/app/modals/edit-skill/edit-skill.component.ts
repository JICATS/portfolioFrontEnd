...
@Component({
  ...
  template: `
    <div class="modal-header">
      ...
      <form>
          ...
          <div class="form-group">
            ...
            <input class="form-control form-control-sm" [(ngModel)]="selectedService.habilidad" id="binHabilidad" type="text" name="binTitulos">
            <label>Grado de habilidad</label>
            <input class="form-control form-control-sm" [(ngModel)]="selectedService.grado" id="binGrado" type="text" name="binInstituciones">
          </div>
    ...
    <div class="modal-footer">
      ...
      <button type="button" class="btn btn-outline-dark" (click)="addSkills()">Modificar</button>
...
export class NgbdModalContentEdit {
  ...
  addSkills(){
    ...
    this,this.loginService.addSkill(newHabilidad).subscribe((lista=>
