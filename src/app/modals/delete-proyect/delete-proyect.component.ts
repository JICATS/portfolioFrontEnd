    ...
    <div class="modal-header">
      ...
      <form>
        ...
        <label>Seleccion el item que desea modificar</label>
          ...
          <input readonly [(ngModel)]="selectedService.nombre" id="binProyecto" class="form-control form-control-sm" type="text" placeholder="Nombre del proyecto" name="binProyecto" >
          <label>Descripción</label>
          <input readonly [(ngModel)]="selectedService.descripcion" id="binDescripcion" class="form-control form-control-sm" type="text" placeholder="Descripcion del proyecto" name="binDescripcion" >
          <label>Fecha</label>
          <input readonly [(ngModel)]="selectedService.fecha" id="binFecha" class="form-control form-control-sm" type="text" placeholder="Fecha de realizacion del proyecto" name="binFecha" >
          <label>Comprobacion</label>
          <input  readonly [(ngModel)]="selectedService.link" id="binLink" class="form-control form-control-sm" type="text" placeholder="Link del proyecto" name="binLink" >
          <label>Imagen</label>
          <input readonly [(ngModel)]="selectedService.url" id="binUrl" class="form-control form-control-sm" type="text" placeholder="url del certificado" name="binUrl" >
...
export class NgbdModalContentDeleteProyect {
  @Input() name:string="";
  ...
  deleteProyecto(){
    ...
    this,this.loginService.deleteProyect(newProyecto.id).subscribe((lista=>
